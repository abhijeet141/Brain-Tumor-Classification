          ...
          <section className="flex flex-col items-center">
            <div className="flex max-w-xl flex-col items-center pb-16 pt-8 text-center lg:pb-48 lg:pt-32">
              ...
              <h1 className="mb-8 font-extrabold text-black text-2xl lg:text-4xl tracking-wide poppins-regular">
                ...
                <span className="text-purple-500">Brain Tumor</span> from MRI
                images
              </h1>
              ...
              <div className="flex w-full flex-col gap-2.5 items-center mt-5">
                <Link
                  href="/pages/predict"
                >
                  <button className="inline-block rounded-lg bg-purple-500 py-5 px-12 text-center text-xl tracking-wide font-semibold text-white outline-none ring-purple-300 transition duration-100 hover:bg-purple-600 focus-visible:ring active:bg-purple-700">Make Prediction</button>
                </Link>
              </div>
            </div>
          </section>
