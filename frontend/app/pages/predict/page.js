  ...
  const sendImgToBackendAndPredict = async (uploadBrinImg) => {
    try {
      ...
      const { data } = await axios.post(
        `https://abhi264-brainimageclassification.hf.space/predict`,
        formData
      );

      setLoading(false);

      if (data?.predicted_result === 'notumor') {
        MySwal.fire({
          html: `
          ...
          `,
          confirmButtonColor: 'text-purple-400',
        });
      } else {
        MySwal.fire({
          html: `
          ...
          `,
          confirmButtonColor: 'test-purple-400',
        });
      }
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <section className="flex flex-col items-center">
            <div className="flex max-w-xl flex-col items-center pb-16 pt-8 text-center lg:pb-48 lg:pt-32">
              <p className="mb-4 font-semibold text-purple-400 md:mb-6 md:text-lg xl:text-xl flex flex-col">
                <span>
              ...
              <div className="mt-6">
                <label>
                  <div className="drop-shadow-md px-12 py-8 rounded-xl focus:outline-none resize-none text-white bg-purple-500 hover:bg-purple-600 hover:cursor-pointer">
